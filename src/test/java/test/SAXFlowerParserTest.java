...
public class SAXFlowerParserTest {
    ...
    private SAXFlowerParser saxFlowerParser;
    private String xmlFilePath;

    @BeforeClass
    public void setUp() {
        saxFlowerParser = new SAXFlowerParser();
        xmlFilePath = "src/main/resources/flowers.xml";
    }

    @Test
    public void testParseFlowers() throws FileNotFoundException {
        List<Flower> flowers = saxFlowerParser.parse(xmlFilePath);
    ...
    public void testParseInvalidFile() {
        ...
        Assert.assertThrows(FileNotFoundException.class, () -> saxFlowerParser.parse(invalidXmlFilePath));
    }
}
